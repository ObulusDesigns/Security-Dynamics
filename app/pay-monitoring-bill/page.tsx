...
export const metadata: Metadata = {
  title: 'Pay Monitoring Bill | Security Dynamics Inc.',
  description: 'Pay your monitoring bill online through our secure AlarmBiller payment portal.',
};

export default function PayMonitoringBillPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-red-100 rounded-full mb-6">
            <CreditCardIcon className="w-10 h-10 text-red-600" />
          </div>
          <h1 className="text-4xl font-bold text-slate-900 mb-4">
            Pay Your Monitoring Bill
          </h1>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
          <div className="space-y-8">
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start">
                  ...
                  <p className="ml-4 text-gray-700">
                    Enter your account number (found on your monitoring agreement or invoice)
                  </p>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0">
            ...
            <div className="grid md:grid-cols-3 gap-6 py-8 border-y border-gray-200">
              ...
              <div className="text-center">
                <CreditCardIcon className="w-8 h-8 text-red-600 mx-auto mb-3" />
                <h3 className="font-semibold text-slate-900 mb-1">Multiple Options</h3>
                <p className="text-sm text-gray-600">
            ...
            <div className="text-center">
              <a
                href="https://securitydynamicsNJ.alarmbiller.com/Dealer/DealerAccount/Login"
                target="_blank"
