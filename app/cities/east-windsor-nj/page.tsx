...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    description: `Professional security in ${city.name}. Business & residential protection. 24/7 monitoring. Call ${COMPANY_INFO.phone}.`,
    images: ['/images/og/east-windsor-nj-security.jpg'],
  },
  alternates: {
