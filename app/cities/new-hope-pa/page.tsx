...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    description: `Protect your ${city.name} business with advanced security. Main Street specialists. Call ${COMPANY_INFO.phone}.`,
    images: ['/images/og/new-hope-pa-security.jpg'],
  },
  alternates: {
