...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    description: `Farm & home security in ${city.name}. Protect your property with 24/7 monitoring. Call ${COMPANY_INFO.phone}.`,
    images: ['/images/og/hopewell-nj-security.jpg'],
  },
  alternates: {
